...
public class HomeController {
	 ...
	 @Autowired
	    ...
	    public String homepage(HttpSession session, Model model) {
	    	...
	    	User user = userServ.showUser((Long)session.getAttribute("userId"));
		...
		public String addBook(@ModelAttribute("newBook")Book newBook, HttpSession session) {
	    	if(session.getAttribute("userId") == null) {
	    		return "redirect:/";
	    	}
			return "newBook.jsp";
		...
		public String showOneBook(@PathVariable("id")Long id, Model model, HttpSession session) {
			...
			if (userId == null) {
				...
				User user = userServ.showUser(userId);
				model.addAttribute("user", user);
			}
